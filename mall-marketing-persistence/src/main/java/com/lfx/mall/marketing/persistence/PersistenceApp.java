...
//        printShardSql(8);
    ...
    public static void printShardSql(int size) {
        for (int i = 0; i < size; i++) {
            String sqlTemplate = "DROP TABLE IF EXISTS `t_group_shopping_%d`;\n" +
                    ...
                    "\n" +
                    "DROP TABLE IF EXISTS `t_group_shopping_member_%d`;\n" +
                    "CREATE TABLE `t_group_shopping_member_%d` (\n" +
            ...
            System.out.printf(sqlTemplate, i, i, i, i);
        }
    }
}
